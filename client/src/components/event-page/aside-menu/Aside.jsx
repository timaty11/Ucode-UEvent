      ...
      <div>
        <div className="  bg-blue-500  dark:bg-dark-bg-900">
          <div className=" start flex">
            <svg className=" ml-4 my-4 h-6 w-6 dark:text-dark-text-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" strokeWidth={1.5}>
      ...
      <div className=" ml-4 mt-2 ">
        <div className="justify-between ">
          <div className="flex items-center pb-2 text-indigo-600 flex items-center dark:text-indigo-400 ">
            <svg className="h-8 w-8 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 27 28" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="pl-2 text-lg font-semibold text-white sm:text-slate-900 md:text-1xl dark:text-dark-text-300">Kyiv, {address}</p>
          </div>
        </div>

        <div className="mb-2 flex justify-between">
          <div className="pb-1 text-indigo-600 flex items-center dark:text-indigo-400">
            <svg className=" -mt-2 h-8 w-8 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" strokeWidth={1.5} stroke="currentColor">
