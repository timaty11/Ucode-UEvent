  ...
  return (
    <div className="px-2 py-5 gap-8 snap-x  overflow-hidden  ">
      <div className="first-elem-div col-sm-4 flex-col rounded-[20px]  overflow-hidden bg-white-700 relative  group relative w-full ">
        <div className="h-full w-full">
          ...
          <div className="mb-3 flex items-center justify-between px-0 md:items-start">
            <div className="mb-3">
              ...
              <p style={{ fontSize: data.title.length > 18 ? '15px' : "1.5rem" }} className={`name text-gray-700 mb-20 font-bold    hover:text-gray-900 hover: dark:text-dark-text-100`}>{ data.title }</p>
        ...
        <div className="second-elem-div rounded-[20px] absolute rounded w-full h-full right-0 top-0 flex flex-col justify-between bg-gray-700 transition duration-700 translate-y-[120%]">
          <div className="mt-2 scale-10 text-white outline-none"></div>
          ...
          <div className="mb-10 scale-10 text-white outline-none">
            ...
            <div className="justify-between md:items-center lg:justify-between">
              <button onClick={() => { location.href = `/event/${data.id}` }} className="fa fa-shopping-cart p-2 pl-11 pr-11 bg-indigo-500 border-2 border-indigo-500 text-gray-100  text-lg rounded-lg transition-colors duration-700 transform  ">
                { t('eventCard.buy') }
              </button>
            </div>
          </div>
