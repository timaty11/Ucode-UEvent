...
const Agreement = ({ setCompleteStep, completeStep }) => {
  const handelClick = async () => {
    try {
      const response = await $api.post(apiClientRoute.createOrganization(4), { isConfirmed: true });
        ...
        <div className="bg-white p-4 rounded-lg shadow-xl py-8 mt-12 dark:bg-gray-800 ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-12 px-2 xl:px-12 mt-4 ">
            <div className="flex space-x-8 mt-8 ">
              <div>
                <svg className="h-12 w-12 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <a href="#" className="text-blue-600 hover:text-blue-800 hover:underline capitalize" title="Read More">
                  Read More
                </a>
              </div>
            </div>
          ...
          <button onClick={() => { if (completeStep.step4.isComplete) { return }; handelClick() }}>
