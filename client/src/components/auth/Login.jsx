    ...
    <form onSubmit={handleLoginSubmit}>
      <section className="bg-gray-50 dark:bg-dark-bg-900">
        <EditForm formMessage={t('signIn.title')}>
          <InputField id="login" name={t('signIn.fild-login')} type="text" placeholder="my_login123" data={userData} setData={setUserData} errors={errors} setErrors={setErrors}>
          ...
          <InputField id="password" name={t('signIn.fild-password')} type="password" placeholder="my_login123" data={userData} setData={setUserData} errors={errors} setErrors={setErrors}>
            <div className="absolute inset-y-0 left-0 flex items-center pl-1 pointer-events-none">
              <svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-dark-text-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label className="text-gray-500 dark:text-gray-300" htmlFor="remember">{t('signIn.checkbox-remember')}</label>
              </div>
            </div>
          ...
          <div className="flex">
            <p className="text-sm font-light text-gray-500 dark:text-dark-text-400">{t('signIn.text-regestration')}</p>
